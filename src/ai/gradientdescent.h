...
class AIGradientDescent {
   ...
   public:
    ...
    static constexpr int MAX_DISTANCE_BEHIND[(int)CCOption::__COUNT] = {75, 75};
    static constexpr float MIN_PROB_BEHIND[(int)CCOption::__COUNT] = {0.75f, 0.75f};
    static constexpr int MAX_DISTANCE_AHEAD[(int)CCOption::__COUNT] = {300, 300};
    static constexpr float MIN_PROB_AHEAD[(int)CCOption::__COUNT] = {0.45f, 0.45f};
